...
process_downscale_GEFS <- function(folder,
  ...
  # -----------------------------------
  input_met_file = "C:\\Users\\mooret\\Desktop\\flare_feeagh\\feeagh_data\\met/GLM_met_obs.csv"
  noaa_location <-  "C:\\Users\\mooret\\OneDrive - Dundalk Institute of Technology\\PROGNOS_offline\\CareyVT\\feeagh-noaa"
  input_met_file_tz = 'GMT'
  local_tzone = 'GMT'
  ...
  maxTempC = 35 # an upper bound of realistic temperature for the study site in deg C
  minTempC = -10 # an lower bound of realistic temperature for the study site in deg C
  ...
  rm(obs.data)
  hrly.obs <- observations#observations %>% aggregate_obs_to_hrly()
